...
import { UserAgentApplication, CacheResult, User, Logger } from "../../msal-core/lib-commonjs";
...
export declare class MsalService extends UserAgentApplication {
    ...
    setProtectedResourceMap(protectedResourceMap: Map<string, Array<string>>): void;
